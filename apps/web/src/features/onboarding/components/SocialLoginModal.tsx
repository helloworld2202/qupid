...
const SocialLoginModal: React.FC<SocialLoginModalProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-sm p-6 relative">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-[#191F28] mb-2">무료로 시작하기</h2>
          <p className="text-[#8B95A1]">원하는 방법으로 빠르게 가입하고 시작하세요</p>
        </div>
